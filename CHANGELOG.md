...
## <small>0.2.2 (2025-01-31)</small>

* chore(config): simplify GitHub release configuration ([0be85e1](https://github.com/rapidefy/lerna-and-monorepo-builder/commit/0be85e1))
* fix(config): update excludeMatches in release notes config ([a031396](https://github.com/rapidefy/lerna-and-monorepo-builder/commit/a031396))
* fix(config): update excludeMatches in release notes config ([53dd6b2](https://github.com/rapidefy/lerna-and-monorepo-builder/commit/53dd6b2))
