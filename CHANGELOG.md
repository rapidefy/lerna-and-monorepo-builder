...
* chore(config): fix formatting in release-it config ([3ef951c](https://github.com/rapidefy/lerna-and-monorepo-builder/commit/3ef951c))
* ``` ([c3cc978](https://github.com/rapidefy/lerna-and-monorepo-builder/commit/c3cc978))
* feat(github): enhance release configuration in .release-it.json ([80d85b5](https://github.com/rapidefy/lerna-and-monorepo-builder/commit/80d85b5))
